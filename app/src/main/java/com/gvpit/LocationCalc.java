...
public class LocationCalc {
    ...
    public static  double distanceBtnLatLng(LatLng latLng1, LatLng latLng2) {
        return haversine(latLng1.latitude, latLng1.longitude, latLng2.latitude, latLng2.longitude);
    }
