...
class GoogleMapGeoObjectPlugin implements GeoObjectPlugin {
	...
	/**
	 * Get the {@link LatLng} instance that represents the {@link GeoObject GeoObject}. It
	...
	/**
	 * Set the {@link Marker} that belongs to the {@link GeoObject GeoObject}
	 * 
	 * @param marker
	 */
	...
	/**
	 * Get the marker that belongs to the {@link GeoObject GeoObject}
	 * 
	 * @return
	 */
